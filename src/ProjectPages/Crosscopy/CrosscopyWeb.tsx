...
import HomepageImage from "./Assets/Crosscopy_homepage_1.png";
import CCMobile from "/CC_mobile.png";

export default function CrosscopyWeb() {
  return (
    <div className="mt-16 ">
      ...
      <p className="mt-6">
        The easiest way to use the service is to simply open the website (
        <a
        ...
        ) in a browser. Users can either choose to create an account, or
        continue anonymously with a linking code. They're then taken to the main
        homepage as seen below where they can paste text or add files.
      </p>
      ...
      <figure className=" border-gray-200   overflow-hidden rounded-xl mt-8">
        ...
        >
          ...
          >
            <img alt="Crosscopy mobile" src={CCMobile} />
          </foreignObject>
        </svg>
        <figcaption className="mt-4 flex gap-x-2 text-sm leading-6 text-gray-300">
          <InformationCircleIcon
            ...
            className="mt-0.5 h-5 w-5 flex-none text-gray-300"
          />
          The Cross Copy homepage on a mobile browser.
        </figcaption>
      </figure>
    </div>
  );
